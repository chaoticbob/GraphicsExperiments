...
#message("GLFM_APP_ASSETS: ${GLFM_APP_ASSETS}")
...
elseif (CMAKE_SYSTEM_NAME STREQUAL "Darwin")
    ...
    add_executable(${GLFM_APP_TARGET_NAME} MACOSX_BUNDLE ${GLFM_APP_SRC} ${GLFM_APP_ASSETS})
    ...
    set_target_properties(${GLFM_APP_TARGET_NAME} PROPERTIES
        ...
        XCODE_ATTRIBUTE_CODE_SIGN_IDENTITY[sdk=macosx*]         "Apple Development" # For convenience
        XCODE_ATTRIBUTE_CODE_SIGN_STYLE                         "Automatic"         # For convenience
    )

...
{
    VulkanBuffer baseColorTexture;
    VulkanBuffer normalTexture;
    VulkanBuffer roughnessTexture;
    VulkanBuffer metallicTexture;
};
...
int main(int argc, char** argv)
{
    ...
    // Window
    // *************************************************************************
    auto window = Window::Create(gWindowWidth, gWindowHeight, "255_pbr_material_textures_d3d12");
    if (!window) {
    ...
    // *************************************************************************
    PBRSceneParameters* pSceneParams = nullptr;

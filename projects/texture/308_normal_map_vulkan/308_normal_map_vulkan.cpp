...
int main(int argc, char** argv)
{
    ...
    {
        std::string shaderSource = LoadString("projects/307_normal_map_d3d12/shaders.hlsl");
        std::string errorMsg;
    ...
    // Window
    // *************************************************************************
    auto window = Window::Create(gWindowWidth, gWindowHeight, "308_normal_map_vulkan");
    if (!window) {

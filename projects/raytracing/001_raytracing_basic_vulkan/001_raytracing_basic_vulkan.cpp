...
void CreateBLAS(VulkanRenderer* pRenderer, VulkanAccelStruct* pBLAS);
...
{
    // layout(binding = 0, set = 0) uniform accelerationStructureEXT topLevelAS;
    VulkanAccelerationDescriptor tlasDescriptor;
    CreateDescriptor(
        pRenderer,
        &tlasDescriptor,
        0, // binding
    ...
    std::vector<VkWriteDescriptorSet> writeDescriptorSets =
        {
            tlasDescriptor.writeDescriptorSet,

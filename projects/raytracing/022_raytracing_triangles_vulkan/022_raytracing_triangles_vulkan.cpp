...
void CreateTLAS(VulkanRenderer* pRenderer, ID3D12Resource* pBLAS, ID3D12Resource** ppTLAS);
void CreateOutputTexture(VulkanRenderer* pRenderer, ID3D12Resource** ppBuffer);
void CreateConstantBuffer(VulkanRenderer* pRenderer, ID3D12Resource* pRayGenSRT, ID3D12Resource** ppConstantBuffer);

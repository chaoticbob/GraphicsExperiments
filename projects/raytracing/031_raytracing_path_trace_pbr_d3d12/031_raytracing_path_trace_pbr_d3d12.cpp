...
int main(int argc, char** argv)
{
    ...
    {
        auto source = LoadString("projects/031_raytracing_path_trace_pbr/shaders.hlsl");
    ...
    // Window
    // *************************************************************************
    auto window = Window::Create(gWindowWidth, gWindowHeight, "031_raytracing_path_trace_pbr_d3d12");
    if (!window) {

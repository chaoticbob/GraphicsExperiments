...
int main(int argc, char** argv)
{
    ...
    // Compile shaders
    // *************************************************************************
    std::string shaderSource = LoadString("faux_render_shaders/render_phong_material.metal");
    ...
    MtlFauxRender::CalculateVertexStrides(graph.Scenes[0].get(), vertexStrides);
    ...
    // Window
    // *************************************************************************
    auto window = GrexWindow::Create(gWindowWidth, gWindowHeight, "404_gltf_basic_material_texture_metal");
    if (!window)
    {

...
int main(int argc, char** argv)
{
    ...
    if (!FauxRender::LoadGLTF(GetAssetPath("scenes/basic_material.gltf"), {}, &graph))
    {
    ...
    // Window
    // *************************************************************************
    auto window = GrexWindow::Create(gWindowWidth, gWindowHeight, "403_gltf_basic_material_vulkan");
    if (!window)
    {

...
int main(int argc, char** argv)
{
    ...
    {
        std::string shaderSource = LoadString("faux_render_shaders/render_phong_material.hlsl");
    ...
    // Window
    // *************************************************************************
    auto window = GrexWindow::Create(gWindowWidth, gWindowHeight, "404_gltf_basic_material_texture_vulkan");
    if (!window)
    {

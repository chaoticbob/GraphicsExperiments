...
int main(int argc, char** argv)
{
    ...
    VulkanBuffer meshletTrianglesBuffer;
    {
        ...
        CHECK_CALL(CreateBuffer(renderer.get(), SizeInBytes(texCoords), DataPtr(texCoords), usageFlags, 0, &texCoordBuffer));
    ...
    while (window->PollEvents())
    {
...

        {
            ...
            PushGraphicsDescriptor(cmdBuf.CommandBuffer, pipelineLayout, 0, 2, VK_DESCRIPTOR_TYPE_STORAGE_BUFFER, &texCoordBuffer);

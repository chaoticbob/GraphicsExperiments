//
// NOTE: At the time of this writing 2024/02/25 - this Vulkan sample renders incorrectly due to a bug
//       bug (https://github.com/microsoft/DirectXShaderCompiler/issues/6250) in DXC version that ships
//       with Vulkan SDK version 1.3.275.0. The bug has been fixed in the DXC repo. Later version of the
//       Vulkan SDK should have a version of DXC with the fix.
//
#include "window.h"
#include "camera.h"

...
int main(int argc, char** argv)
{
    ...
    {
        // 
        // Having VK_QUERY_PIPELINE_STATISTIC_MESH_SHADER_INVOCATIONS_BIT_EXT 
    ...
    while (window->PollEvents())
    {
        ...
        CHECK_CALL(vkBeginCommandBuffer(cmdBuf.CommandBuffer, &vkbi));
        {
            ...
            PushGraphicsDescriptor(cmdBuf.CommandBuffer, pipelineLayout, 0, 5, VK_DESCRIPTOR_TYPE_STORAGE_BUFFER, &instancesBuffer);
